...
top_levels <- unique(top$player_name)
...
magick::image_write(
  plot_with_nfl,
  path = "/Users/heff/Desktop/jheffernan/cover2figures_tutorials/nfl_qb_cumulative_epa/nfl_qb_cum_epa.png"
)
```
